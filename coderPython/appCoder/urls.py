...
urlpatterns = [
    ...
    path("tecnologia/", ListItemsTecnologia.as_view(), name="Tecnologia"),
    path("muebles/", ListItemsMuebles.as_view(), name="Muebles"),
    path("cocina/", ListItemsCocina.as_view(), name="Cocina"),
    path("decoracion/", ListItemsDecoracion.as_view(), name="Decoracion"),
